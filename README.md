...
Le frontend est déployé automatiquement sur GitHub Pages après chaque push sur `main` :
https://azizcompaore.github.io/residence-noema/

GitHub Pages héberge uniquement le frontend statique. Les fonctions connectées au backend Django (données dynamiques, connexion, formulaires et synchronisation admin) nécessitent un backend public configuré séparément.
