...
import { apartmentImageSources, getApartmentFallbackPhotos } from '../utils/apartmentImages';
...
export const ApartmentsSection: React.FC<ApartmentsSectionProps> = ({
  ...
  const statusConfig: Record<string, { label: string; style: React.CSSProperties }> = {
    available: { label: 'Disponible', style: { backgroundColor: '#eaf7ee', color: '#1f8f5a', borderColor: '#9ad4af' } },
    option: { label: 'Sous Option', style: { backgroundColor: '#fff7ed', color: '#b45309', borderColor: '#fbbf24' } },
    reserved: { label: 'Réservé', style: { backgroundColor: '#eff6ff', color: '#1d4ed8', borderColor: '#93c5fd' } },
    sold: { label: 'Vendu', style: { backgroundColor: '#f5f5f5', color: '#525252', borderColor: '#d4d4d4' } }
  };
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="mx-auto grid max-w-5xl grid-cols-1 gap-8 md:grid-cols-2">
          {filteredApartments.map((apartment) => {
            ...
            const heroPhoto = apartmentImageSources(apartment.type, apartment.photos || [])[0];
            const fallbackPhoto = getApartmentFallbackPhotos(apartment.type)[0];
            ...
            return (
              ...
              >
                ...
                <div className="relative aspect-16/10 overflow-hidden bg-neutral-100 cursor-pointer" onClick={() => onSelectApartment(apartment)}>
                  ...
                  {/* Status Badge */}
                  <div
                    className="absolute top-3.5 right-3.5 text-xs font-bold px-3 py-1 rounded-full border shadow-xs"
                    style={status.style}
                  >
                    {status.label}
                  </div>
                  ...
                  <div className="space-y-4 pt-2 border-t border-neutral-100">
                    ...
                    <div className="grid grid-cols-1 gap-2.5">
                      ...
                      >
                        ...
                        <span>SIMULER MON FINANCEMENT POUR CE BIEN</span>
                      </button>
