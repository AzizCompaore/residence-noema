...
export const ApartmentDetailModal: React.FC<ApartmentDetailModalProps> = ({
  ...
  const fallbackPhotos = getApartmentFallbackPhotos(apartment.type);
  const photos = apartmentImageSources(apartment.type, apartment.photos || []);
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 lg:gap-8">
            ...
            <img
              ...
              onError={(event) => {
                ...
                event.currentTarget.src = fallbackPhotos[activePhotoIndex % fallbackPhotos.length];
              }}
