  ...
  return (
    <header 
      ...
      className={`fixed top-0 left-0 right-0 z-40 transition-all duration-300 ${
        isScrolled 
          ? 'bg-[#fdfaf4]/55 backdrop-blur-md shadow-xs border-b border-[#e5c9b1]/70 py-3' 
          : 'bg-[#fdfaf4]/35 backdrop-blur-md border-b border-[#e5c9b1]/70 py-5'
      }`}
    >
        ...
        <div className="flex items-center justify-between">
          ...
          {!showUrielGroup && (
            <nav id="desktop-nav-links" className="hidden lg:flex items-center gap-9 text-[13px] font-medium text-neutral-600">
              <a href="#votre-projet" className="hover:text-neutral-950 transition-colors">
                Votre projet
              </a>
              ...
              <a href="#simulateur" className="hover:text-neutral-950 transition-colors text-[#5b3a2e] font-semibold flex items-center gap-1.5">
                <Calculator className="w-3.5 h-3.5 text-[#d15a3a]" />
                Simulateur
              </a>
          ...
          <div className="hidden sm:flex items-center gap-4">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 rounded-md px-2 py-1 text-[13px] font-medium text-neutral-600 transition-colors duration-200 hover:text-neutral-950 hover:bg-neutral-50 focus:outline-none focus:ring-2 focus:ring-[#d15a3a] cursor-pointer"
              title="Aperçu page de transition Uriel Group"
            >
              <span className="inline-flex h-1.5 w-1.5 rounded-full bg-[#d15a3a] transition-all duration-300" />
              <span>{showUrielGroup ? '← Retour à NOEMA' : 'Uriel Group'}</span>
            </button>
            ...
            {user ? (
              <div className="relative">
                <button
                  ...
                  className="inline-flex h-11 w-11 items-center justify-center rounded-full border border-[#e5c9b1] bg-white/80 transition-all hover:border-[#d15a3a] hover:bg-white"
                ...
                {accountMenuOpen && (
                  <div className="absolute right-0 top-full mt-2 w-72 rounded-xl border border-neutral-200 bg-white p-2 shadow-xl" role="menu">
                    ...
                    <button type="button" onClick={() => { setAccountMenuOpen(false); onOpenSimulator(); }} className="flex w-full items-center gap-3 rounded-lg px-3 py-2.5 text-left text-sm text-neutral-700 hover:bg-neutral-50" role="menuitem">
                      <Calculator className="h-4 w-4 text-[#d15a3a]" /> Faire une nouvelle simulation
                    </button>
                    <button type="button" onClick={() => { setAccountMenuOpen(false); onOpenVisioAppointment(); }} className="flex w-full items-center gap-3 rounded-lg px-3 py-2.5 text-left text-sm text-neutral-700 hover:bg-neutral-50" role="menuitem">
                      <CalendarDays className="h-4 w-4 text-[#d15a3a]" /> Prendre rendez-vous
                    </button>
            ...
            >
              <Calculator className="w-3.5 h-3.5 text-[#e5c9b1]" />
            </button>
